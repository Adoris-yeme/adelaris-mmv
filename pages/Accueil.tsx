...
import type { Page, Modele } from '../types';
import ImageLightbox from '../components/ImageLightbox';
import { ExpandIcon, ChevronLeftIcon, ChevronRightIcon, TrackIcon } from '../components/icons';
...
const Accueil: React.FC<AccueilProps> = ({ models, setCurrentPage }) => {
        ...
        return (
            <div className="py-8">
                ...
                <div className="relative">
                    ...
                    <div ref={scrollContainerRef} className="flex gap-6 overflow-x-auto pb-4 scroll-smooth snap-x snap-mandatory" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
                        {models.map(model => (
                            <div key={model.id} className="snap-start flex-shrink-0 w-[280px]">
